...
# Runs RAQT mission split sets 1..5 sequentially.
...
PACKS=(
  ...
  "pack_rust_audit_raqt_mission_set3_v1_0.yaml"
  "pack_rust_audit_raqt_mission_set4_v1_0.yaml"
  "pack_rust_audit_raqt_mission_set5_v1_0.yaml"
)

mkdir -p "${OUT_ROOT}"

echo "== RAQT mission sets 1..5 batch run =="
echo "repo:        ${REPO_ROOT}"
