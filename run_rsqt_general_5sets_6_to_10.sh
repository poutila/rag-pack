...
# Runs RSQT general split sets 6..10 sequentially.
...
OUT_ROOT="${OUT_ROOT:-XREF_WORKFLOW_II_new/xref_state/RSQT_GENERAL_5SETS_6_TO_10_$(date +%y%m%d_%H%M%S)}"

PACK_DIR="XREF_WORKFLOW_II_new/tools/rag_packs"
PACKS=(
  "pack_rust_audit_rsqt_general_set6_v1_0.yaml"
  "pack_rust_audit_rsqt_general_set7_v1_0.yaml"
  "pack_rust_audit_rsqt_general_set8_v1_0.yaml"
  "pack_rust_audit_rsqt_general_set9_v1_0.yaml"
  "pack_rust_audit_rsqt_general_set10_v1_0.yaml"
)

mkdir -p "${OUT_ROOT}"

echo "== RSQT sets 6..10 batch run =="
echo "repo:        ${REPO_ROOT}"
